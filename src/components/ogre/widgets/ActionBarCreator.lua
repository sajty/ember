...
function ActionBarCreator:buildCEGUIWidget()
	...
	self.wieldComboBox:subscribeEvent("ListSelectionAccepted", self.WieldComboBox_Change ,self)
	...
	self.edibleComboBox:subscribeEvent("ListSelectionAccepted", self.EdibleComboBox_Change ,self)
